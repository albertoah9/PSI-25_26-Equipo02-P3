...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        s3 = Song.objects.create(title='Don\'t Forget to Remember', artist='Beegees', language='EN', audio_file='Beegees - Dont Forget to Remember.mp3', lrc_file='Beegees - Dont Forget to Remember.lrc', background_image='Beegees - Dont Forget to Remember.jpg', category='POP')
